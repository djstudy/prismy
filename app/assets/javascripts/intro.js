...
$(document).on('ready page:load', function () {
  ...
  $('#intro-line-container').delay( 10000 ).show().queue(function(){
    var i = 0;
    $("#intro-line").typed({
      strings: [ "전세계 인구 70억명이 쫙 서있다고 생각했을 때, ^1000 <br>모두가 다른 위치에 서있을 것이라고 생각해요. ^1000 <br>다수는 없고 모두가 소수자가 되는 것이죠.",
                "^1000 <br>게이들이 눈 뜨면 섹스만하지 않거든요. ^1000 <br>저는 섹스를 좋아하는 편이지만 그래도 제가 가장 좋아하는 순간은 ^1000 <br>애인과 함께 동묘시장에 가서 골동품을 보고 천 원 짜리 브로치를 사주는 거에요.",
                "^1000 <br>소수자를 위한 법은 단순히 소수자를 위한 특별한 혜택이 아닌 ^1000 <br>한 인간의 삶을 위한, 생존을 위한 것입니다.",
                "^1000 <br>영어같은 경우는 mother와 father가 있고 그걸 합쳐서 parent라는 단어가 되는데, ^1000 <br>한국어는 그게 없어요. 그냥 부모가 있을 뿐이죠.",
                "^1000 <br>아직도 한국 사회에선 섹스를 하고 싶어하지 않아하는 사람들한테 굉장히 뭐라고 하는 경향이 있더라구요.",
                "^1000 <br>당신은 최근에 성병 검사를 받아본 적이 있나요?",
                "^1000 <br>남성 여성 중에 하나로 자신의 성을 선택하지 않는다니까 저 같은 경우는 어색했어요. ^1000 <br>이게 가능한건가? 하면서 많이 당황스러워 했던 것 같아요."],
      startDelay: 1000,
      typeSpeed: 50,
      backSpeed: 0,
      backDelay: 1000,
